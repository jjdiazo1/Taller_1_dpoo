...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar pais del atleta");
	 ...
	 * un nombre de atleta al usuario y luego leer lo que escriba el usuario.
	 * 
	 * @return La cadena de caracteres del pais del atleta que retorne la calculadora.
	 */
	private void ejecutarPaisAtleta() {
		
		System.out.println("\n" + "Ejecutar Buscar el Pais de un Atleta" + "\n");

		String atletita = input("Por favor ingrese el nombre del atleta");
		String resultado = calculadora.pais(atletita);
		
		System.out.println("Se encontro el pais del atleta " + atletita);
		System.out.println("Su pais es" + resultado);
